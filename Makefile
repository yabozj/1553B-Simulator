#VAR=mem.o reg.o Sim1553B_chan.o simbc.o simbus.o simmt.o simrt.o definition.o log.o wordParser.o stdafx.o
VAR=mem.o reg.o Sim1553B_chan.o simbc.o simbus.o simmt.o simrt.o definition.o log.o wordParser.o stdafx.o
...
simbc.o:reg.h mem.h simbus.h simbc.cpp stdafx.o
	g++ -c $(CFLAGS) -o simbc.o simbc.cpp
simrt.o:reg.h mem.h simbus.h simrt.cpp stdafx.o
	g++ -c $(CFLAGS) -o simrt.o simrt.cpp
simmt.o:reg.h mem.h simbus.h simmt.cpp stdafx.o
